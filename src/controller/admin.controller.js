...
module.exports = {
        ...
        try {
            ...
            if (response.modifiedCount > 0) {
                ...
                FailedResponse(
                    res,
                    response,
                    "admin could not updated successfully"
                );
            }
        } catch (error) {
            /* handle error */
            ...
            .catch((error) => {
                ...
                if (code) {
                    switch (code) {
                        ...
                        default:
                            return ServiceUnavilableResponse(
                                res,
                                error.response.data.err
                            );
                    }
    ...
    getAllAdmin: async (req, res) => {
        try {
            ...
            const hash = await bcrypt.hash("Admin@locma_22", salt);
